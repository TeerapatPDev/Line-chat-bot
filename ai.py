...
10. กรณีพิเศษ "เครื่องดื่ม"
11. ถ้าผู้ใช้พิมพ์คำว่า "หิวข้าว" หรือมีคำว่า "ข้าว"

→ ต้องเลือก category = "เมนูข้าว" เท่านั้น
→ ห้ามใช้ mixed
...
user: "หิวข้าว" → {"type":"food","category":"เมนูข้าว","items":["ข้าวผัด","กะเพราไก่ไข่ดาว","ข้าวมันไก่"]}
user: "อยากกินข้าว" → {"type":"food","category":"เมนูข้าว","items":["ข้าวหมูแดง","ข้าวขาหมู","ข้าวคลุกกะปิ"]}
